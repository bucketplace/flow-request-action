...
exports.fetchDeliveryFlow = void 0;
...
function fetchDeliveryFlow(application, flow, body) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield node_fetch_1.default(`${getBaseUrl()}/applications/${application}/delivery/${flow}`, {
            method: 'POST',
            headers: {
...
exports.fetchDeliveryFlow = fetchDeliveryFlow;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core.debug(`Request delivery ${flow} flow for application ${application} version ${version}`);
            yield delivery_flow_1.fetchDeliveryFlow(application, flow, {
                version,
